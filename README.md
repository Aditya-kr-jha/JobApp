...
1. Homepage - Effortless Job Search:
   ![App Screenshot](C:\WebDevPython\jobapp\screenshots\Screenshot (165) - Copy.png)
2. Detailed Job Information:
   ![App Screenshot](C:\WebDevPython\jobapp\screenshots\Screenshot (166).png)
3. Employer Job Posting Interface:
   ![App Screenshot](C:\WebDevPython\jobapp\screenshots\Screenshot (170).png)
4. Subscribtion Page:
   ![App Screenshot](C:\WebDevPython\jobapp\screenshots\Screenshot (169).png)
5. Thankyou Page:
   ![App Screenshot](C:\WebDevPython\jobapp\screenshots\Screenshot (167).png)
